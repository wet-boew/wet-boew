...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      options: {
        banner: '/* Web Experience Toolkit (WET) / Boîte à outils de l\'expérience Web (BOEW) wet-boew.github.com/wet-boew/License-eng.txt / wet-boew.github.com/wet-boew/Licence-fra.txt */\n',
        stripBanners: true
      },
      dist: {
    ...
    copy: {
      dist: [
        { src: ['lib/jquery/jquery-1.9.1.min.js'], dest: 'dist/vendor/', filter: 'isFile' },
        { src: ['lib/jquery.mobile/*min.js'], dest: 'dist/vendor/', filter: 'isFile' }
       ]
    },
