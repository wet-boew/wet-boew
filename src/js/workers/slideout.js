...
(function ($) {
	...
	_pe.fn.slideout = {
		...
		_exec: function (elm) {
			...
			// Add the wrappers
			innerWrapper = elm.wrap('<div><div id="slideoutWrapper" role="application" aria-labelledby="toggle-link"><div id="slideoutInnerWrapper"></div></div></div>').parent(); // This is used for overflow: hidden and animate.
