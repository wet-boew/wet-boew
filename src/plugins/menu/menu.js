...
(function($, window, vapour) {
  ...
  */
    ...
    var expand = function(elment, scopeitems) {
        var $elm = $(elment),
            _elm = $elm.hasClass("wb-menu") ? $elm.data() : $elm.parents(".wb-menu").first().data(),
        ...
        switch ($code) {
            ...
            case 40:
                if ($elm.find(".expandicon").length > 0) {
                    ...
                    var $anchor = $elm.attr("href").slice(1),
  ...
  */
    ...
    return $document.on("keydown", ".wb-menu .item", function(event) {
