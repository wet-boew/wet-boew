		...
		window.Modernizr.load({
			...
			complete: function() {
				var $form = $elm.find( "form" ),
					...
					i, len,	ariaLiveString, validator;
				...
				validator = $form.validate({
					...
					showErrors: function( errorMap ) {
						...
						var _i18nText = i18nText,
							...
							summary, key, i, len, $error, prefix, $fieldName, $fieldset;
						...
						if ( $errors.length !== 0 ) {
							...
							if ( submitted ) {
								...
								if ( i !== 0 ) {
									ariaLiveString = $errors.filter( "[for=" + key + "]" )[ 0 ].innerHTML;
									if ( ariaLiveString !== $ariaLive.html() ) {
										$ariaLive.html( ariaLiveString );
									}
