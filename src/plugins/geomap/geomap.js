		...
		if ( event.currentTarget === elm ) {
			...
			if ( !i18nText ) {
				...
				i18nText = {
					close: i18n( "%close" ),
					colon: i18n( "%colon" ),
					hiddenLayer: i18n( "%geo-hiddenlayer" ),
					toggleLayer: i18n( "%geo-togglelayer" ),
					labelSelect: i18n( "%geo-labelselect" ),
					select: i18n( "%geo-select" ),
					zoomFeature: i18n( "%geo-zoomfeature" ),
					baseMapTitle: i18n( "%geo-basemaptitle" ),
					baseMapURL: i18n( "%geo-basemapurl" ),
					baseMapURLTxt: i18n( "%geo-basemapurltxt" ),
					scaleLine: i18n( "%geo-scaleline" ),
					mousePosition: i18n( "%geo-mouseposition" ),
					access: i18n( "%geo-accessibilize" ),
					accessTitle: i18n( "%geo-accessibilizetitle" ),
					attribLink: i18n( "%geo-attributionlink" ),
					attribTitle: i18n( "%geo-attributiontitle" ),
