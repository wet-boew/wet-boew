...
wb.date = {
    ...
    wb.html = {
        /**
         * @property get_html_translation_table
         * @member.of wb.html
         * @param {object} requires a object to bind translation properties
         * @param {string} different quote style for the table properties
         * @returns {string} modified string with appropiate markup/format for a entry object
         * @credits http://phpjs.org/functions/get_html_translation_table/
         */
         ...
         * @param {string} encoding type - "ENT_NOQUOTES", "ENT_QUOTES", "HTML_ENTITIES","HTML_SPECIALCHARS",  "ENT_COMPAT"
         * @returns {string} modified string with appropiate escaped characters
         * @credits http://phpjs.org/functions/html_entity_decode/
         */
