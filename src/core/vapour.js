...
(function( $, window, document, undef ) {
	...
	vapour = {
		...
		wbDisable: function() {
			var wbDisableQuery = vapour.pageUrlParts.params.wbdisable,
				wbDisableLocalStorage = ( localStorage ? localStorage.getItem( "wbdisable" ) : null );

			vapour.wbDisable = ( ( wbDisableQuery ? wbDisableQuery.toLowerCase() : wbDisableLocalStorage ) === "true" );
	...
	// Determine if enhancements should be disabled and cache the result in the vapour object
	vapour.isDisabled = vapour.wbDisable();
